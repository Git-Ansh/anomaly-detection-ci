...
\item[\textbf{RQ2}] Can we exploit this cross-model agreement to produce more efficient conformal prediction sets---smaller shortlists when models agree, larger safety nets when they disagree?
...
\item \textbf{NEEDS CAREFUL REVIEW (56\% of bugs):} Disagree-group. Mean set size 8.52. Developer receives a shortlist with an uncertainty flag and both models' candidates. Even here, reducing 30 candidate components to approximately 8 represents a 73\% reduction in the developer's search space compared to unassisted triage.
\end{itemize}
