...
\begin{itemize}
\item \textbf{AUTO-TRIAGE (29\% of bugs):} Agree-group singletons. 90\% accuracy with formal coverage guarantee. Assign automatically with spot-check auditing. The 10\% error rate among auto-triaged singletons necessitates periodic quality checks; however, this is substantially lower than the 37--44\% human triager misassignment rate~\cite{jeong2009improving}.
